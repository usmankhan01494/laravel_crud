...
<main class="app-main">
	<div class="app-content-header">
		...
		<!--begin::Row-->
			<div class="row">
				<div class="col-sm-6"><h3 class="mb-0">Add About</h3></div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<label class="form-label" for="exampleInputEmail1">About Tittle</label>
						<input type="text" class="form-control" name="title" placeholder="Enter About Tittle">
					</div>
                 </div>
                 <div class="col-lg-6">
					<div class="form-group">
