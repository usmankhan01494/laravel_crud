  ...
  <body class="login-page bg-body-secondary">
    <div class="login-box">
      <div class="login-logo">
        <a href="../index2.html"><b>Ecommerce Admin Login</a>
      </div>
      <!-- /.login-logo -->
      <div class="card">
        <div class="card-body login-card-body">
          ...
          <form method="post" action="{{ route('user.processRegister') }}">
            ...
            <div class="input-group mb-3">
              <input value="{{ old('name') }}" type="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nmae" />
